...
class FirebaseAdmobPage extends StatelessWidget {
  String title;
  FirebaseAdmobPage({super.key,this.title = 'Firebase Admob'});

  @override
  Widget build(BuildContext context) {
    List firebaseList = ["SHOE BANNER","SHOW INTERSTITIAL","SHOW REWARDED VIDEO"];
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          onPressed: () => Get.back(),
              ...
              Padding(padding: EdgeInsets.all(5.w),
                child: Container(
                  ...
                  child:ListView.builder(
                    itemCount: firebaseList.length,shrinkWrap: true,
